...
if ( !class_exists('catchthemes_update_checker') ):
	
/**
 * A update checker class. 
 * 
 */
class catchthemes_update_checker {
...
$catchthemes_update_checker = new catchthemes_update_checker(
   'create-pro',
   'http://catchthemes.com/update-notifier/create-pro/theme_meta_data.json'
);